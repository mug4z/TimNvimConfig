...
//===================================================================
==================== READ THIS BEFORE CONTINUING ====================zs
=====================================================================
========                                    .-----.          ========
========         .----------------------.   | === |          ========
========         |.-""""""""""""""""""-.|   |-----|          ========
...
-- Set the line number to relative
-- vim.opt.relativenumber = true

-- Change the number of spaces there is in a tab
vim.cmd("set tabstop=8")

-- Change the number of spaces when autoindent or doing >> << commands
vim.cmd("set shiftwidth=4")

-- Remap the ctrl-\ctrl-n command to Esc
...
-- Set the keymap for toggleterm
vim.opt.hidden = true
vim.keymap.set("n", "<leader>tf", "<Cmd>ToggleTerm direction=float<CR>", { desc = "Open terminal float" })
vim.keymap.set(
	"n",
	"<leader>th",
...
require("lazy").setup({
	...
	{ -- 42 header plugin
		...
		opts = {
			...
			user = "tfrily", -- Your user.
			mail = "tfrily@student.42lausanne.ch", -- Your mail.
			-- add other options.
		},
